    ...
    */
    async renderList(req, res){
        ...
        try{
            ...
            res.render("list/client/main-page.html", { data: { clients, errors, messages }})
        } catch(e){
            req.session.errors = [e.message]
            res.redirect("/client")
        }
    ...
    */ 
    async saveNewClient(req, res){
        ...
        try {
            ...
            req.session.messages = [`The client ${client.name} ${client.surname} has been created successfully`]
        } catch (e) {
            req.session.errors = [e.message]
        }
        res.redirect("/client")
    ...
    */ 
    async saveEditedClient(req, res){
        ...
        try {
            ...
            req.session.messages = [`The client ${client.name} ${client.surname} has been edited successfully`]
        } catch (e) {
            req.session.errors = [e.message]
        }
        res.redirect("/client")
    ...
    */ 
    async delete(req, res){
        ...
        try {
            ...
            req.session.messages = [`The client with ID ${id} has been deleted successfully`]
        } catch (e) {
            req.session.errors = [e.message]
        }
        res.redirect("/client")
